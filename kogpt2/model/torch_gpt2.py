...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        return transformer_outputs  # 전체 층을 가져오지 않는다.

        hidden_states = transformer_outputs[0] # batch x seq_length x n_embed
        lm_logits = self.lm_head(hidden_states) # batch x seq_length x vocab_size
